          ...
          <div :class="{on: !loginWay}">
            <section>
              ...
              <section class="login_message">
                ...
                <img class="get_verification" src="http://localhost:4000/captcha" alt="captcha" @click="getCapcha" ref="capcha">
              </section>
            </section>
          </div>
...
<script>
import AlertTip from '../../components/AltertTip/AlertTip'
import {reqSendCode, reqSmsLogin, reqPwdLogin} from '../../api'

export default {
  data () {
    return {
      loginWay: true, // ture代表短信
      computeTime: 0, // 计时的时间
  ...
  methods: {
    ...
    getCapcha () {
      // 每次指定的src要不一样
      this.$refs.capcha.src = 'http://localhost:4000/captcha?time=' + Date.now()
    }
  }
}
</script>
